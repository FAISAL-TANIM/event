                ...
                <div class="my-account">
                    <div class="account-tab">
                        <ul>
                            ...
                            <li class="active"><a href="javascript:void(0);" id="changePassword">Change Password</a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content profile-con">
                        <div class="personal-edit">
                            <a href="account_password.php#"><span class="icon icon-pencile"></span>Edit Profile</a>
                        </div>
                    ...
                    <div class="tab-content order-con">
                            ...
                            <tr>
                                ...
                                <td class="detail">
                                    ...
                                    <div class="detailTd">
                                        ...
                                        <a href="account_password.php#">Phone : +91-79-12345678</a>
                                    </div>
                                </td>
                        ...
                        <div class="booking-status">
                            <a href="account_password.php#" class="cancel">Cancel your Booking</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="functionality-box">
                                ...
                                <h3>Booking</h3>
                                <p>
                                    Manage calendars , share availability, easily view events, type or location.
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="functionality-box">
                                ...
                                <h3>Operations</h3>
                                <p>
                                    Create detailed reports, work orders and generate invoices.
                                </p>
                            </div>
                        </div>
                    </div>
